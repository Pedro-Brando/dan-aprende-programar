...
Uma calculadora de terminal que aceita expressões como `12 + 7` e devolve o resultado, em loop até o usuário digitar `sair`.
...
- Estrutura de um arquivo `.py` executável
