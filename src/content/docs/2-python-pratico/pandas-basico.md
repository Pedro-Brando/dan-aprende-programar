---
title: Pandas básico
description: A biblioteca queridinha para manipular dados tabulares em Python — DataFrame, filtros, groupby.
---
...
- Instalar pandas e abrir um CSV com `pd.read_csv`
- O que é um `DataFrame` e como inspecionar com `head`, `info`, `describe`
- Selecionar colunas e filtrar linhas
- Agrupar e agregar com `groupby`
- Salvar resultado em CSV ou Excel
