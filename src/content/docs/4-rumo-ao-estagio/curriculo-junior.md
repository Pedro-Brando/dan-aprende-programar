...
- Estrutura de uma página: dados, objetivo, formação, projetos, habilidades
- Por que "projetos" pesa mais que "cursos" para júnior sem experiência
- Palavras-chave que ATS procura (nome de stack, ferramentas, conceitos)
- O que NÃO colocar (foto, idade, RG, hobby genérico)
- Modelos honestos vs canva-bonito-vazio
