...
- Os clássicos para júnior: FizzBuzz, palíndromo, contar vogais, inverter string
- Como pensar em voz alta sem travar (e por que isso é metade da nota)
- Perguntas comuns sobre Python: mutável vs imutável, lista vs tupla, GIL (resumo)
- Leitura de código: explicar o que um trecho faz
- Como reagir quando você não sabe a resposta (a forma certa de dizer "não sei")
