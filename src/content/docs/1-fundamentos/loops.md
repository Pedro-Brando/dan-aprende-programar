---
title: Loops
description: for e while — como repetir ações sem copiar e colar código mil vezes.
---
...
- `range()` para repetir N vezes ou contar de A até B
- Loop `while` para repetir até uma condição mudar
- `break` para sair antes da hora e `continue` para pular uma volta
- Como evitar loops infinitos por engano
