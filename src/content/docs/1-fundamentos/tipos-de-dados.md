...
description: Os tipos básicos do Python — inteiros, decimais, texto, booleanos e None — e como descobrir o tipo de qualquer valor.
---
...
- Os 5 tipos básicos: `int`, `float`, `str`, `bool`, `None`
- Por que `1` e `1.0` são diferentes
- Como descobrir o tipo de um valor com `type()`
- Conversão entre tipos: `int()`, `float()`, `str()`, `bool()`
- Por que somar texto com número quebra o programa
